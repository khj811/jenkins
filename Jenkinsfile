pipeline {
    ...
    environment {
        ...
        NHN_REGISTRY_URL = '847f310f-kr1-registry.container.nhncloud.com'  // NCR Registry URL
        ...
        stage('Build') {
            steps {
                script {
                    ...
                    sh "echo ${NHN_SECRET_KEY} | docker login ${NHN_REGISTRY_URL}/${NCR_REPOSITORY} -u ${NHN_ACCESS_KEY} --password-stdin"
